...
package com.adamantium.company.gwtp.client.application.details.ui.tabs;
...
/**
 * This is a basic implementation of a {@link com.gwtplatform.mvp.client.TabPanel} that must be subclassed.
 * Subclasses can style the tab panel in
...
public abstract class BaseTabPanel extends Composite implements TabPanel {
     ...
     *
     * @param panelContent The {@link com.google.gwt.user.client.ui.IsWidget} to set in the main panel,
