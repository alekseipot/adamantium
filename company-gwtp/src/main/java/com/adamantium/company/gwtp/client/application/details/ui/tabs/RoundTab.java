 ...
 * can be protected so that it is only displayed when a given {@link com.gwtplatform.mvp.client.proxy.Gatekeeper}
 * can allow access. If a {@code null}
 * {@link com.gwtplatform.mvp.client.proxy.Gatekeeper} is used then the tab is always accessible.
 */
